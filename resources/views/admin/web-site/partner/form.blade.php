@if(isset($model))
    {{ Form::model($model, ['url' => route('dashboard.partners.update', $model->id), 'method' => 'PUT','files' => true]) }}
@else
    {{ Form::open(['url' => route('dashboard.partners.store'), 'method' => 'post', 'files' => true]) }}
@endif
...
<div class="grid simple ">
    ...
    <div class="grid-body ">
        <div class="row">
            ...
            <div class="col-md-6 col-lg-6">
                <div class="form-group">
                    {!! Form::label('type', 'Associativer Partner type:', ['class' => 'form-label']) !!}
                    {!! Form::select('type',array('school_partner' => 'School Partner', 'recruiter_partner' => 'Recruiter Partner', 'student_partner' => 'Student Partner') ,null, ['class' => 'form-control']) !!}
        ...
        <div class="grid-body ">
            <div class="row">
                ...
                <div class="col-md-12 col-lg-12">
                    @if(isset($model))
                        <img src="{{url(isset($model)?$model->getPartnerImage():imageNotFound())}}" height="250"
                             id="partner_pic_img">

                    @else
                        <img src="{{isset($model)?$model->getPartnerImage():imageNotFound()}}" height="250"
                             id="partner_pic_img">
                    @endif
                </div>
                ...
                <div class="form-group col-md-12 col-lg-12">
                    ...
                    <input type="file" id="partner_pic" name="partner_pic_image"
                           onclick="anyFileUploader('partner_pic')">
                    <small id="slider_help_text" class="help-block"></small>
                    <div class="progress progress-striped active" role="progressbar" aria-valuemin="0"
                         aria-valuemax="100"
                         aria-valuenow="0">
                        <div id="partner_pic_progress" class="progress-bar progress-bar-success"
                             style="width: 0%">
                        </div>
                    </div>
                    <input type="hidden" id="partner_pic_path" name="partner_pic" class="form-control"
