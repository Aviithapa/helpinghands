@if(isset($model))
    {{ Form::model($model, ['url' => route('dashboard.teams.update', $model->id), 'method' => 'PUT','files' => true]) }}
@else
    {{ Form::open(['url' => route('dashboard.teams.store'), 'method' => 'post', 'files' => true]) }}
@endif
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-6">
                <div class="form-group">
                    ...
                    {!! Form::select('type',array('team' => 'team') ,null, ['class' => 'form-control']) !!}
            ...
            <div class="col-md-6 col-lg-6">
                <div class="form-group">
                    {!! Form::label('LinkedIn', 'Linked ln:', ['class' => 'form-label']) !!}
