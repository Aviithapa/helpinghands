@if(isset($model))
    {{ Form::model($model, ['url' => route('dashboard.steps.update', $model->id), 'method' => 'PUT','files' => true]) }}
@else
    {{ Form::open(['url' => route('dashboard.steps.store'), 'method' => 'post', 'files' => true]) }}
@endif
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-6">
                <div class="form-group">
                    ...
                    {!! Form::select('type',array('steps' => 'Steps') ,null, ['class' => 'form-control']) !!}
        ...
        <div class="row">
            <div class="col-md-6 col-lg-6">
                <div class="form-group">
                    ...
                    {!! Form::textarea('content',null, ['class' => 'form-control ckeditor','id'=>'text-editor']) !!}
                    {!! $errors->first('content', '<div class="text-danger">:message</div>') !!}
                </div>
            </div>
            <div class="col-md-6 col-lg-6">
                <div class="form-group">
                    {!! Form::label('excerpt', 'Order:', ['class' => 'form-label']) !!}
