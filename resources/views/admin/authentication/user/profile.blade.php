    ...
    <div>
        <div class="row-fluid">
            <div class="span12">
                ...
                {{ Form::model($user, ['url' => route('dashboard.users.profile.post'), 'method' => 'POST','files' => true]) }}
                    ...
                    <div class="grid-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12 col-lg-12">
                                ...
                                <input type="hidden" id="user_path" name="image" class="form-control"
                ...
                @if($authUser->mainRole()->name != 'travel_guide')
                ...
                <div class="grid simple ">
                    ...
                    <div class="grid-body">
                        <div class="row" id="js-authentication-section-off">
                            <button type="button" id="js-edit-user-authentication"
                        ...
                        <div class="row u-hide" id="js-authentication-section">
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="form-group">
                                    ...
                                    <small>To change email please contact Going Nepal.</small>
