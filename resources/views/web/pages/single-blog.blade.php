...
@section('content')
    ...
    @foreach($blog as $blog)
        <section class="hero-wrap hero-wrap-2" style="background-image: url('{{$blog->getNewsImage()}}');" data-stellar-background-ratio="0.5">
                            ...
                            <aside class="single_sidebar_widget popular_post_widget">
                                ...
                                @foreach($blogs as $blog)
                                    <div class="media post_item">
                                        <img src="{{$blog->getNewsImage()}}" alt="{{getSiteSetting('site_title') != null? getSiteSetting('site_title'): ''}}" style="height:50px;width: 50px;">
                                        <div class="media-body">
                                            <a href="{{url('single-blog/'.$blog->slug)}}">
                                                <h3>{{str_limit($blog['title'],100)}}</h3>
                                            </a>
                                            <p>{{$blog->created_at}}</p>
                                        </div>
                                    </div>
