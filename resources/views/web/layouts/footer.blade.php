            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="widget subscribe no-box">
                        <h5 class="widget-title">{{getSiteSetting('site_title')!= null? getSiteSetting('site_title'): ''}}<span></span></h5>
                        <p>{{getSiteSetting('copy_right')!= null? getSiteSetting('copy_right'): ''}}</p>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <p>{{getSiteSetting('copy_right')!= null? getSiteSetting('copy_right'): ''}}
                    </p>
                </div>
            </div>
        </div>
